...
use phpdotnet\phd\PI\DBHTMLHandler;
use phpdotnet\phd\PI\PHPDOCHandler;
use phpdotnet\phd\Reader;
use phpdotnet\phd\Render;
use function phpdotnet\phd\v;

abstract class XHTML extends \phpdotnet\phd\Package\Generic\XHTML {
    ...
    protected $pihandlers = array(
        'dbhtml'        => DBHTMLHandler::class,
        'dbtimestamp'   => DBHTMLHandler::class,
        'phpdoc'        => PHPDOCHandler::class,
    );
