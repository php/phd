...
<div id="type-rendering-methodsynopsis-parameters" class="chapter">
 ...
 <div class="section">
  <p class="para">3. Function/method with one parameter with whitespace in type tag</p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>function_name</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.html" class="type bool">bool</a></span> <code class="parameter">$yesOrNo</code></span>)</div>

 </div>

 <div class="section">
  <p class="para">4. Function/method with optional parameter</p>
 ...
 <div class="section">
  <p class="para">5. Function/method with nullable parameter</p>
 ...
 <div class="section">
  <p class="para">6. Function/method with nullable optional parameter</p>
 ...
 <div class="section">
  <p class="para">7. Function/method with reference parameter</p>
 ...
 <div class="section">
  <p class="para">8. Function/method with union type parameter</p>
 ...
 <div class="section">
  <p class="para">9. Function/method with more than three parameters</p>
