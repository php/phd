...
<div id="type-rendering-constructorsynopsis-parameters-and-return-type" class="chapter">
 ...
 <div class="section">
  <p class="para">4. Constructor with one parameter with whitespace in type tag</p>
  <div class="constructorsynopsis dc-description"><span class="modifier">abstract</span> <span class="methodname"><strong>ClassName::__construct</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.html" class="type bool">bool</a></span> <code class="parameter">$yesOrNo</code></span>)</div>

 </div>

 <div class="section">
  <p class="para">5. Constructor with optional parameter</p>
 ...
 <div class="section">
  <p class="para">6. Constructor with nullable parameter</p>
 ...
 <div class="section">
  <p class="para">7. Constructor with nullable optional parameter</p>
 ...
 <div class="section">
  <p class="para">8. Constructor with reference parameter</p>
 ...
 <div class="section">
  <p class="para">9. Constructor with union type parameter</p>
 ...
 <div class="section">
  <p class="para">10. Constructor with more than three parameters</p>
