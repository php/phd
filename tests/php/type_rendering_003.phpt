...
$xml_file = __DIR__ . "/data/type_rendering_constructorsynopsis_parameters.xml";
...
?>
--EXPECT--
Filename: type-rendering-constructorsynopsis-parameters.html
Content:
<div id="type-rendering-constructorsynopsis-parameters" class="chapter">

 <div class="section">
  <p class="para">1. Constructor with no parameters</p>
 ...
 <div class="section">
  <p class="para">2. Constructor with one parameter</p>
 ...
 <div class="section">
  <p class="para">3. Constructor with one parameter with whitespace in type tag</p>
